...
class TrackXReward:
    def __init__(self, env,
        ...
        self.total_episode_length_steps = self.env.episode_length_in_seconds * self.env.control_frequency_hz
    ...
    def reward_and_info(self, info, done):
        ...
        current_local_linear_velocity = self.env.data.qvel[:3]
        ...
        # Total reward
        reward = (
            target_velocity_reward - 0.1 * yaw_current_velocity ** 2 + pitch_roll_position_penalty + torque_penalty
        )
        reward *= 10

...
class TrackXYReward:
    ...
    def reward_and_info(self, info, done):
        ...
        yaw_current_velocity = current_local_angular_velocity[2]

        yaw_penalty = -0.5 * np.abs(desired_local_yaw_velocity - yaw_current_velocity)
        ...
        info[f"reward/track_xy/target_velocity_reward"] = target_velocity_reward
        info[f"reward/track_xy/yaw_penalty"] = yaw_penalty
        info[f"reward/track_xy/pitch_roll_position_penalty"] = pitch_roll_position_penalty

...
def get_config(algorithm_name):
    ...
    config.hindsight_replay = False
    config.learning_starts = 5000
    config.batch_size = 256
    config.gamma = 0.99
    config.ensemble_size = 2
    config.policy_delay = 0                                 # does not work anymore
    ...
    config.state_history_length = 1
    config.action_space_mode = "default"                                                         # "default", "frequency", "residual"

...
from gait_in_eight.algorithms.crossq.default.tanh_transformed_distribution import (
    TanhTransformedDistribution,
)
from gait_in_eight.algorithms.crossq.default.batch_renorm import BatchRenorm
...
def get_processed_action_function(env_as_low, env_as_high):
    def get_clipped_and_scaled_action(
        action, env_as_low=env_as_low, env_as_high=env_as_high
    ):

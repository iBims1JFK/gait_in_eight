...
from gait_in_eight.algorithms.sac.utd.policy import get_policy
from gait_in_eight.algorithms.sac.utd.critic import get_critic
from gait_in_eight.algorithms.sac.utd.entropy_coefficient import EntropyCoefficient
from gait_in_eight.algorithms.sac.utd.replay_buffer import ReplayBuffer
from gait_in_eight.algorithms.sac.utd.rl_train_state import RLTrainState
    ...
    def train(self):
        ...
        def update(
            ...
            for i in range(self.q_update_steps):
                ...
                all_indices = jnp.arange(2)
                m_indices = jax.random.choice(key=sample_key, a=all_indices, shape=(2,), replace=False)
